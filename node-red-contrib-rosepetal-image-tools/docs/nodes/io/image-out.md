...
### Filename Prefix
- **Type**: String | msg | flow | global (optional)
- **Default**: "image"
- **Description**: Custom prefix for generated filenames
- **Options**:
  - **String**: Static prefix (e.g., "camera1")
  - **msg.***: Dynamic prefix from message (e.g., `msg.deviceId`)
  - **flow.***: Prefix from flow context
  - **global.***: Prefix from global context
...
### Dynamic Prefix from Message
```javascript
// msg.deviceId = "sensor42"
// Config: Prefix from msg.deviceId
// Result: /output/sensor42_20240109_143022.jpg
```
