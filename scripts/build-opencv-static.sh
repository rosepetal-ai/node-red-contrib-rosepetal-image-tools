...
ls -la "${INSTALL_DIR}/lib/"*.a 2>/dev/null || ls -la "${INSTALL_DIR}/lib/"
echo ""
echo "3rdparty libraries:"
ls -la "${INSTALL_DIR}/lib/opencv4/3rdparty/"*.a 2>/dev/null || echo "(check ${INSTALL_DIR}/lib/opencv4/3rdparty/)"
echo "=========================================="
